...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("-ppi", "--probe_gene_network", required=True, help="path probe_gene_network")
    arg_parser.add_argument("-sg", "--seed_gene_scores", required=True, help="path list of seed genes and association scores")
    arg_parser.add_argument("-ol", "--output_links", required=True, help="path to list of gene-gene links")
    arg_parser.add_argument("-og", "--output_genes", required=True, help="path to list of genes")
    arg_parser.add_argument("-nf", "--nedbit_features", required=True, help="path to NeDBIT features")
    arg_parser.add_argument("-nh", "--nedbit_header", required=True, help="data header 0/1")
    arg_parser.add_argument("-gr", "--output_gene_ranking", required=True, help="path to output gene ranking")
    arg_parser.add_argument("-qt1", "--quantile_1", required=True, help="quantile threshold 1")
    arg_parser.add_argument("-qt2", "--quantile_2", required=True, help="quantile threshold 2")
